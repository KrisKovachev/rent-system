...
- User - моделът представляварегистриран потребител в системата
...
- един потребител моце да бъде наемател по много договори
...
- RentalRequest - модела представлява заявка за наем от потребител
...
- deleteImage() - използва се за изтриване за индивидуална снимква при редакция на профил
...
- компоненти
- условна логика за роли и достп
