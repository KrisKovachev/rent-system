...
<div class="max-w-7xl mx-auto px-6 py-10 space-y-12">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('apartments.create') }}"
           class="inline-flex items-center gap-2 px-6 py-3
                  ...
                  hover:bg-gray-800 transition hover:scale-[1.03] active:scale-[0.97]">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @forelse($apartments as $a)
            <div
                class="group bg-white rounded-3xl overflow-hidden border
                ...
                <div class="relative h-56 overflow-hidden">
                    ...
                    @else
                        <div
                            class="w-full h-full bg-gray-200 flex items-center
                    ...
                    <div
                        ...
                        <a href="{{ route('apartments.show', $a) }}"
                           class="px-5 py-2 bg-white text-black rounded-xl text-sm font-medium
                                  hover:scale-105 transition">
                            View
                        </a>

                        <a href="{{ route('apartments.edit', $a) }}"
                           class="px-5 py-2 bg-black text-white rounded-xl text-sm font-medium
                                  hover:scale-105 transition">
                            Edit
                        </a>
                    </div>
        ...
        @empty
            <div class="lg:col-span-3 text-center py-24 text-gray-500">
